...
public class IndexController {
	...
	public ModelAndView index() {
		System.out.println("1111111111111111111113");
		return new ModelAndView("redirect:/admin");
	}

	@RequestMapping(value = "${jeeweb.admin.url.prefix}",method = RequestMethod.GET)
	public String index(Model model) {
		System.out.println("1111111111111111111114");
		// 加载通知公告
	...
	public String themeCookie(@PathVariable String theme, HttpServletRequest request) {
		System.out.println("1111111111111111111115");
	...
	public String main() {
		System.out.println("1111111111111111111116");
